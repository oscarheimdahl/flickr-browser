...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"style/imageGallery.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"style/imagePreview.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
var getPhotoPage = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            page = fetch(url).then(function (res) {
              return res.json();
            });
  ...
  return function getPhotoPage(_x) {
    return _ref.apply(this, arguments);
  };
}(); // Available size suffixes, in order are: s, q, t, m ,n ,-, z, c ,b, o


var imageInfoToURL = function imageInfoToURL(serverID, id, secret, size) {
  return "https://live.staticflickr.com/".concat(serverID, "/").concat(id, "_").concat(secret, "_").concat(size, ".jpg");
};

module.exports = {
  getPhotoPage: getPhotoPage,
  imageInfoToURL: imageInfoToURL
...
},{}],"assets/spinner.png":[function(require,module,exports) {
module.exports = "/spinner.8aad048f.png";
},{}],"assets/arrow-right.png":[function(require,module,exports) {
module.exports = "/arrow-right.8f3da8fb.png";
},{}],"js/imagePreview.js":[function(require,module,exports) {
"use strict";

var _spinner = _interopRequireDefault(require("../assets/spinner.png"));

var _arrowRight = _interopRequireDefault(require("../assets/arrow-right.png"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var lastPreviewedImage = null;

var buildImagePreviewContainer = function buildImagePreviewContainer() {
  ...
  var loadingIndicator = buildPreviewLoadingIndicator();
...
var buildButtonRow = function buildButtonRow() {
  var prevImageButton = buildPrevImageButton();
  var nextImageButton = buildNextImageButton();
...
var buildNextImageButton = function buildNextImageButton() {
  var nextButton = document.createElement('button');
  nextButton.className = 'preview-button';
  var img = new Image();
  img.alt = 'next';
  img.src = _arrowRight.default;
  nextButton.appendChild(img);
  nextButton.addEventListener('click', showNextImage);
  return nextButton;
};

var buildPrevImageButton = function buildPrevImageButton() {
...
var buildPreviewLoadingIndicator = function buildPreviewLoadingIndicator() {
...
var setLoadingIndicatorVisibility = function setLoadingIndicatorVisibility(visibility) {
...
var hideImagePreview = function hideImagePreview() {
  var imagePreview = document.getElementById('image-preview-container');
  imagePreview.style.display = 'none';
  var images = document.getElementById('image-preview').children;
...
var previewImage = function previewImage(image, id, target) {
  lastPreviewedImage = target;
  var previewContainer = document.getElementById('image-preview-container');
  var cachedImage = document.getElementById(id);
  if (cachedImage) cachedImage.style.display = 'block';else appendNewImageToPreviewContainer(image);
  previewContainer.style.display = 'flex';
}; // Loads the new high res image or shows it if it is cached.


var appendNewImageToPreviewContainer = function appendNewImageToPreviewContainer(image) {
  var images = document.getElementById('image-preview');
  var cacheSize = 50;
  setLoadingIndicatorVisibility('visible');
  image.addEventListener('load', function () {
    return setLoadingIndicatorVisibility('hidden');
  });
  images.appendChild(image);
  if (images.childNodes.length > cacheSize) images.removeChild(images.childNodes[0]);
};

var setKeybinds = function setKeybinds() {
...
var showPrevImage = function showPrevImage() {
  var prevThumbnail = lastPreviewedImage.parentElement.previousSibling;
  if (!prevThumbnail) return;
  var prevImage = prevThumbnail.lastChild;
  hideImagePreview();
  prevImage.dispatchEvent(new MouseEvent('click'));
};

var showNextImage = function showNextImage() {
  var nextThumbnail = lastPreviewedImage.parentElement.nextSibling;
  if (!nextThumbnail) return;
  var nextImage = nextThumbnail.lastChild;
  hideImagePreview();
  nextImage.dispatchEvent(new MouseEvent('click'));
};

module.exports = {
  buildImagePreviewContainer: buildImagePreviewContainer,
  previewImage: previewImage
};
},{"../assets/spinner.png":"assets/spinner.png","../assets/arrow-right.png":"assets/arrow-right.png"}],"js/imageGallery.js":[function(require,module,exports) {
"use strict";
...
var _flickrFetcher = require("./flickrFetcher");
...
var buildImageGallery = function buildImageGallery(parent) {
  var imageGalleryContainer = document.createElement('div');
  ...
  var pageLoadingIndicator = buildPageLoadingIndicator();
...
var fetchNextPage = function fetchNextPage() {
  ...
  (0, _flickrFetcher.getPhotoPage)(pageToFetch).then(appendImagesFromPage).catch(function (e) {
    setLoadingMessage('Could not load images');
  });
};

var appendImagesFromPage = function appendImagesFromPage(pageData) {
  pageData.photos.photo.forEach(function (photoInfo) {
...
var buildPageLoadingIndicator = function buildPageLoadingIndicator() {
...
var buildThumbnailContainer = function buildThumbnailContainer() {
...
var buildImage = function buildImage(photoInfo, size) {
  var img = new Image();
  img.loading = 'lazy';
  img.alt = "Title: ".concat(photoInfo.title);
  img.setAttribute('photoInfo', JSON.stringify(photoInfo));
  img.src = (0, _flickrFetcher.imageInfoToURL)(photoInfo.server, photoInfo.id, photoInfo.secret, size);
  return img;
};

var buildThumbnailImage = function buildThumbnailImage(photoInfo) {
  var img = buildImage(photoInfo, 'q');
  img.className = 'thumbnail';
  img.addEventListener('click', onThumbnailClick);
  return img;
};

var buildPreviewImage = function buildPreviewImage(photoInfo) {
  var img = buildImage(photoInfo, 'b');
  img.className = 'image-preview';
  img.id = photoInfo.id;
  return img;
};

var setLoadingMessage = function setLoadingMessage(message) {
  document.getElementById('page-loading-indicator').innerText = message;
};

var onGalleryScroll = function onGalleryScroll(e) {
...
var canLoad = function canLoad() {
  if (preventLoad) return false;
  preventLoad = true;
  setTimeout(function () {
    return preventLoad = false;
  }, 1000);
  return true;
};

var appendThumbnail = function appendThumbnail(photoInfo) {
  var imageGallery = document.getElementById('image-gallery');
  var thumbnailContainer = buildThumbnailContainer();
  var image = buildThumbnailImage(photoInfo);
  image.addEventListener('load', function () {
    return thumbnailContainer.childNodes[0].remove();
  });
...
var onThumbnailClick = function onThumbnailClick(e) {
  var photoInfo = JSON.parse(e.target.getAttribute('photoInfo'));
  var image = buildPreviewImage(photoInfo);
  (0, _imagePreview.previewImage)(image, photoInfo.id, e.target);
};

var _default = buildImageGallery;
exports.default = _default;
},{"./flickrFetcher":"js/flickrFetcher.js","./imagePreview":"js/imagePreview.js"}],"js/index.js":[function(require,module,exports) {
"use strict";
...
require("../style/imageGallery.scss");

require("../style/imagePreview.scss");

require("./flickrFetcher");

var _imageGallery2 = _interopRequireDefault(require("./imageGallery"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

//to support async
(0, _imageGallery2.default)(document.body);
},{"babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","../style/index.scss":"style/index.scss","../style/imageGallery.scss":"style/imageGallery.scss","../style/imagePreview.scss":"style/imagePreview.scss","./flickrFetcher":"js/flickrFetcher.js","./imageGallery":"js/imageGallery.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
